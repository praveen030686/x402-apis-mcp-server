...
// ══════════════════════════════════════════════════════════════
server.registerTool("crypto_get_price", {
...
server.registerTool("crypto_get_signal", {
...
server.registerTool("crypto_deep_analysis", {
...
server.registerTool("crypto_ai_report", {
...
// ══════════════════════════════════════════════════════════════
server.registerTool("finance_stock_price", {
...
server.registerTool("finance_stock_profile", {
...
server.registerTool("finance_stock_financials", {
...
server.registerTool("finance_stock_news", {
...
server.registerTool("finance_forex_rate", {
...
server.registerTool("finance_forex_convert", {
...
server.registerTool("finance_market_overview", {
...
server.registerTool("finance_ai_report", {
...
// ══════════════════════════════════════════════════════════════
server.registerTool("web_extract_text", {
...
server.registerTool("web_extract_metadata", {
...
server.registerTool("web_extract_contacts", {
...
server.registerTool("web_extract_pdf", {
...
server.registerTool("web_extract_structured", {
...
server.registerTool("web_extract_product", {
...
server.registerTool("web_extract_batch", {
...
server.registerTool("web_extract_compare", {
...
server.registerTool("web_extract_translate", {
...
server.registerTool("web_extract_ai_summary", {
